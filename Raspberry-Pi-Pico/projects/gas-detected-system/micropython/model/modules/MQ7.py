...
class MQ7(BaseMQ):
    ...
    def __init__(self, channel=0, pinHeater=-1, boardResistance=10, baseVoltage=5.0, measuringStrategy=BaseMQ.STRATEGY_ACCURATE):
        # Call superclass to fill attributes
        super().__init__(channel, pinHeater, boardResistance, baseVoltage, measuringStrategy)
        pass
